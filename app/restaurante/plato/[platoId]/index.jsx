    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: tokens.colors.surface }} edges={["top"]}>
            <View style={styles.container}>
                {/* Back (ahora te lleva a visualizar-carta) */}
                <TouchableOpacity
                ...
                {/* Descripción */}
                {!!data?.descripcion && <Text style={styles.desc}>{data.descripcion}</Text>}
                    ...
                    <View style={styles.allergenGrid}>
                        {alerg.map((a) => (
                            <View key={a.id ?? a.nombre} style={styles.allergenCard}>
                                <Image
                                    source={{
                                        uri: a?.imagen || "https://via.placeholder.com/80x80.png?text=⚠️",
                                    }}
